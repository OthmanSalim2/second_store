<div class="ps-cart"><a class="ps-cart__toggle" href="#"><span><i>{{ $cart->all()->count() }}</i></span><i
            class="ps-icon-shopping-cart"></i></a>
    <div class="ps-cart__listing">
        <div class="ps-cart__content">
            @foreach ($cart->all() as $item)
                <div class="ps-cart-item"><a class="ps-cart-item__close" href="#"></a>
                    <div class="ps-cart-item__thumbnail"><a href="{{ $item->product->permalink }}"></a><img
                            src="{{ $item->product->image }}" alt=""></div>
                    <div class="ps-cart-item__content"><a class="ps-cart-item__title"
                            href="{{ $item->product->permalink }}l">{{ $item->product->name }}</a>
