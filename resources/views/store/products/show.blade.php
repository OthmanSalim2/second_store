                    ...
                    <form action="{{ route('cart') }}" method="post">
                        ...
                        <div class="ps-product__info">
                            ...
                            <h3 class="ps-product__price">
                                <x-currency :amount="$product->sale_price" /> <del>
                                    <x-currency :amount="$product->price" />
                                </del>
                            </h3>
                            <div class="ps-product__block ps-product__quickview">
                                <h4>QUICK REVIEW</h4>
                                <p>{{ Str::words($product->description, 50) }}</p>
                            </div>
                            ...
                            <div class="ps-product__shopping"><button type="submit" class="ps-btn mb-10">Add to
                                    cart<i class="ps-icon-next"></i></button>
