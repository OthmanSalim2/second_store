<x-store-layout>
            ...
            <ul>
                ...
                <li class="ps-banner ps-banner--white" data-index="rs-100" data-transition="random"
                    data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-rotate="0"><img
                        class="rev-slidebg" src="{{ asset('assets/store/images/slider/2.jpg') }}" alt=""
                        data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="5"
                        data-no-retina>
                                    ...
                                    <div class="ps-shoe mb-30">
                                        <div class="ps-shoe__thumbnail">
                                            ...
                                            <a class="ps-shoe__favorite" href="#"><i
                                                    class="ps-icon-heart"></i></a><img src="{{ $product->image }}"
                                                alt=""><a class="ps-shoe__overlay"
                                                href="{{ $product->permalink }}"></a>
                                        </div>
    ...
    <div class="ps-section--offer">
        <div class="ps-column"><a class="ps-offer" href="product-listing.html"><img
                    src="{{ asset('assets/store/images/banner/home-banner-1.png') }}" alt=""></a></div>
        <div class="ps-column"><a class="ps-offer" href="product-listing.html"><img
                    src="{{ asset('assets/store/images/banner/home-banner-2.png') }}" alt=""></a></div>
    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 ">
                        <div class="ps-hotspot"><a class="point first active" href="javascript:;"><i
                            ...
                            </a><img src="{{ asset('assets/store/images/hot-deal.png') }}" alt=""></div>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="ps-shoe">
                                <div class="ps-shoe__thumbnail">
                                    <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite"
                                        ...
                                        src="{{ $product->image }}" alt=""><a class="ps-shoe__overlay"
                                        href="{{ $product->permalink }}"></a>
                                </div>
                                <div class="ps-shoe__content">
                                    <div class="ps-shoe__variants">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                        <div class="ps-post">
                            <div class="ps-post__thumbnail"><a class="ps-post__overlay"
                                    ...
                                    src="{{ asset('assets/store/images/blog/1.jpg') }}" alt=""></div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                        <div class="ps-post">
                            <div class="ps-post__thumbnail"><a class="ps-post__overlay"
                                    href="blog-detail.html"></a><img
                                    src="{{ asset('assets/store/images/blog/2.jpg') }}" alt=""></div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                        <div class="ps-post">
                            <div class="ps-post__thumbnail"><a class="ps-post__overlay"
                                    href="blog-detail.html"></a><img
                                    src="{{ asset('assets/store/images/blog/3.jpg') }}" alt=""></div>
